...
// 	protoc        v3.13.0
// source: test/sampleProto/sample.proto
...
func (x *ResponsList) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var File_test_sampleProto_sample_proto protoreflect.FileDescriptor
...
var (
	file_test_sampleProto_sample_proto_rawDescOnce sync.Once
	file_test_sampleProto_sample_proto_rawDescData = file_test_sampleProto_sample_proto_rawDesc
)

func file_test_sampleProto_sample_proto_rawDescGZIP() []byte {
	file_test_sampleProto_sample_proto_rawDescOnce.Do(func() {
		file_test_sampleProto_sample_proto_rawDescData = protoimpl.X.CompressGZIP(file_test_sampleProto_sample_proto_rawDescData)
	})
...
func init() { file_test_sampleProto_sample_proto_init() }
func file_test_sampleProto_sample_proto_init() {
	if File_test_sampleProto_sample_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_test_sampleProto_sample_proto_goTypes,
		DependencyIndexes: file_test_sampleProto_sample_proto_depIdxs,
		MessageInfos:      file_test_sampleProto_sample_proto_msgTypes,
	}.Build()
	File_test_sampleProto_sample_proto = out.File
	file_test_sampleProto_sample_proto_rawDesc = nil
	file_test_sampleProto_sample_proto_goTypes = nil
	file_test_sampleProto_sample_proto_depIdxs = nil
}
